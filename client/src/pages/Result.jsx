...
const Result = () => {
  return (
    <div className="mx-4 my-10 lg:mx-44 mt-14 min-h-[75vh]">
            ...
            {/* left side  */}
              ...
              <div className="flex flex-col">
                ...
                <div className="rounded-md border border-gray-300 h-full relative bg-layer overflow-hidden ">
                  <img src={assets.image_wo_bg} alt="image without" />
                  {/* <div className="absolute right-1/2 bottom-1/2 transform translate-x-1/2 translate-y-1/2 ">
                    <div className="border-4 border-violet-600 rounded-full h-12 w-2 border-t-transparent animate-spin">
                    </div>
                  </div> */}
                </div>              
              </div>
